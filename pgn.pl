...
my $outdirect = join "/", @name;
	...
	open OUT, ">".$outdirect."/".$id."_black_win.txt"; # 	change this for output
	...
	open OUT, ">".$outdirect."/".$id."_black_loss.txt"; 	
	print OUT "position\tQueen\tRook\tBishop\tKnight\n";
	...
	open OUT, ">".$outdirect."/".$id."_black_draw.txt"; 
	print OUT "position\tQueen\tRook\tBishop\tKnight\n";
...
my $outdirect = join "/", @name;
	...
	open OUT, ">".$outdirect."/".$id."_white_win.txt"; # 	change this for output
	print OUT "position\tQueen\tRook\tBishop\tKnight\n";
	...
	open OUT, ">".$outdirect."/".$id."_white_loss.txt"; 	
	print OUT "position\tQueen\tRook\tBishop\tKnight\n";
	...
	open OUT, ">".$outdirect."/".$id."_white_draw.txt"; 
	print OUT "position\tQueen\tRook\tBishop\tKnight\n";
